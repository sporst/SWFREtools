 ...
 *
 */
public final class GradientBevelFilter implements IFileElement {
	 ...
	 */
	public GradientBevelFilter(final UINT8 numColors, final RGBAList gradientColors,
	...
	public int getBitLength() {
		return SWFParserHelpers.addBitLengths(numColors, gradientColors, gradientRatio, blurX, blurY, angle,
				distance, innerShadow, knockout, compositeSource, onTop, passes);
	}
