...
public class CxFormWithAlphaParser {
	...
	public static CxFormWithAlpha parse(final SWFBinaryParser parser, final String fieldName) throws SWFParserException {
		...
		final SBits alphaMultTerm = parseSBitsIf(parser, nBits, 0x00006, hasMultTerms.value(), fieldName + "::BlueMultTerm");
		...
		final SBits alphaAddTerm = parseSBitsIf(parser, nBits, 0x00006, hasAddTerms.value(), fieldName + "::BlueAddTerm");
