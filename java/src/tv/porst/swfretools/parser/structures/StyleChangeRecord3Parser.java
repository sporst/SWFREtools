...
public class StyleChangeRecord3Parser {
	...
	public static StyleChangeRecord3 parse(final SWFBinaryParser parser, final int fillBits, final int lineBits, final String fieldName) throws SWFParserException {
